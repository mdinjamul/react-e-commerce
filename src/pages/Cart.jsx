...
const Cart = () => {
  const { cart, clearCart, shipping_fee, subtotal } = useCartContextHook();

  // remove all from cart page if no cart item found
  if (cart.length === 0) {
    return (
      <EmptyCartStyle>
        <center>
      ...
      <div className="container">
        ...
        <div className="cart-item">
          {cart.map((currentElement) => {
            return <CartItem key={currentElement.id} {...currentElement} />;
          })}
        </div>
        <hr />
        <div className="cart-two-button">
          ...
          <PrimaryButton className="btn btn-clear-cart" onClick={clearCart}>
            Clear Cart
          </PrimaryButton>
        </div>
        {/* Subtotal Area */}
        <div className="container order-total--amount">
          <div className="order-total--subdata">
            ...
            <div>
              <p>Order Total:</p>
              <p>
                <PriceFormat price={subtotal + shipping_fee} />
              </p>
            </div>
          </div>
        </div>
